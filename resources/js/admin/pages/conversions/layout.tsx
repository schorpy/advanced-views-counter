...
export default function ConversionsLayout({ children }: ConversionsLayoutProps) {
...
<Button onClick={handleClick} className="font-semibold text-white">
  {/* <Link to="/conversion/new">+ Add New Conversion</Link> */}
  + Add New Conversion
</Button>
          </div>
      <div className="space-y-6 p-10 pb-16 md:block dark:bg-gray-900">
        {/* <div className="space-y-0.5">
          <h2 className="text-2xl font-bold tracking-tight dark:text-white">Conversions</h2>
          <p className="text-muted-foreground">
            Manage your account Conversions and set e-mail preferences.
          </p>
        </div> */}
