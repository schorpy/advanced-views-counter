 ...
 * Class Template
 *
 * Represents the Template class for Popzy.
 *
 * @package AVC\Core
 */
class Template
{
	...
	const FRONTEND_TEMPLATE_NAME = 'Popzy';
	const FRONTEND_TEMPLATE_SLUG = 'popzy';
	...
	public function load_custom_template($template)
	{
		if (get_page_template_slug() === self::FRONTEND_TEMPLATE) {
			$template_file_dir = POPZY_PLUGIN_DIR . 'views/templates/' . self::FRONTEND_TEMPLATE;
