 ...
 * @return void
 */
function advico_install_page($page_title, $page_name, $page_template_file_name)
{
...
function advico_delete_post_views($post_id)
{
	global $wpdb;
	...
	$wpdb->delete($wpdb->prefix . 'advico_views', $data['where'], $data['format']);
}
